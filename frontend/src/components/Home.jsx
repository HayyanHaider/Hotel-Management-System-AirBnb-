            ...
            <div className="col-lg-10">
              <div className="card shadow-sm border-0 rounded-4 overflow-hidden">
                  ...
                  <div className="row g-0">
                    ...
                    <div className="col-md-4">
                      <div className="p-3 border-end">
                        <label className="form-label fw-semibold small text-dark">Where</label>
                        <input 
                          type="text" 
                    ...
                    <div className="col-md-3">
                      <div className="p-3 border-end">
                        <label className="form-label fw-semibold small text-dark">Check in</label>
                        <input 
                          type="date" 
                          className="form-control border-0 p-0" 
                          value={checkIn}
                    ...
                    <div className="col-md-3">
                      <div className="p-3 border-end">
                        <label className="form-label fw-semibold small text-dark">Check out</label>
                        <input 
                          type="date" 
                          className="form-control border-0 p-0" 
                          value={checkOut}
                    ...
                    <div className="col-md-2">
                      <div className="p-3 d-flex flex-column justify-content-center h-100">
                        <label className="form-label fw-semibold small text-dark">Who</label>
                        <select 
                ...
                <div className="position-absolute top-50 end-0 translate-middle-y me-3">
                  <button className="btn btn-danger rounded-circle p-2" style={{width: '48px', height: '48px'}}>
